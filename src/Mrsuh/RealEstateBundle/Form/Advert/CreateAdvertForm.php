...
class CreateAdvertForm extends AbstractType
{
    ...
    {
        $builder->add('advert_seller_name1', 'text', ['required' => false, 'attr' =>['value' => null]]);
        $builder->add('advert_seller_phone1', 'text', ['required' => false, 'attr' =>['value' => null]]);
        $builder->add('advert_seller_name2', 'text', ['required' => false, 'attr' =>['value' => null]]);
        $builder->add('advert_seller_phone2', 'text', ['required' => false, 'attr' =>['value' => null]]);
        $builder->add('advert_seller_name3', 'text', ['required' => false, 'attr' =>['value' => null]]);
        $builder->add('advert_seller_phone3', 'text', ['required' => false, 'attr' =>['value' => null]]);
        ...
        $builder->add('object_region_city', 'choice', ['choices' => $this->params['object_region_city']]);
