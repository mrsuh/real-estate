...
class C
{
    ...
    const MATERIAL_WALL_OBJECT_OLD_FUND = 2;
    const MATERIAL_WALL_OBJECT_PANEL = 3;
    const MATERIAL_WALL_OBJECT_BRICK = 4;
    const MATERIAL_WALL_OBJECT_OTHER= 5;
    const MATERIAL_WALL_OBJECT_KHRUSCHEV = 6;
    const MATERIAL_WALL_OBJECT_STALIN = 7;
    const MATERIAL_WALL_OBJECT_BRICK_MONOLITHIC = 8;


    const TYPE_WATER_SUPPLY_OBJECT_WEll = 1;
    const TYPE_WATER_SUPPLY_OBJECT_WATER_HEATER = 2;
    const TYPE_WATER_SUPPLY_OBJECT_GAS_BOILER = 3;
    const TYPE_WATER_SUPPLY_OBJECT_CONNECTIVITY = 4;
    const TYPE_WATER_SUPPLY_OBJECT_COLUMN = 5;
    const TYPE_WATER_SUPPLY_OBJECT_SUMMER_WATER = 6;
    const TYPE_WATER_SUPPLY_OBJECT_CENTRAL_WATER_SUPPLY = 7;
    const TYPE_WATER_SUPPLY_OBJECT_HAVE_NOT = 8;
